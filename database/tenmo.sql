...
CREATE TABLE user_transactions (
	...
	CONSTRAINT FK_transaction_sender_user FOREIGN KEY (sender_id) REFERENCES tenmo_user (user_id),
	CONSTRAINT FK_transaction_receiver_user FOREIGN KEY (receiver_id) REFERENCES tenmo_user (user_id)
);
